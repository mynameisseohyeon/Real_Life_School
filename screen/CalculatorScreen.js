...
const CalculatorScreen = () => {
  ...
  const handleCalculate = () => {
    ...
    const calculationResult = calculateSalary(salaryType, severanceIncluded, salary, nonTaxableIncome, dependents, children);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <View style={styles.radioContainer}>
          ...
          <RadioButton selected={salaryType} onChange={setSalaryType} options={['연봉', '월급']} />
        </View>

        {salaryType === '연봉' && (
          <View style={styles.radioContainer}>
            <Text style={styles.label}>퇴직금 포함 여부</Text>
            <RadioButton selected={severanceIncluded} onChange={setSeveranceIncluded} options={['포함', '별도']} />
          </View>
        )}
      </View>
